...
{ 
    ...
    { 
        return [
            [['type', 'application_type', 'is_gift', 'discount', 'numbers', 'use_range', 'less_consumption', 'reduce_money', 'days_num', 'stack_use', 'send_num', 'use_num', 'opt_id'], 'integer'],
            [['less_consumption', 'start_date', 'end_date'], 'required'],
