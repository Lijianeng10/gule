...
class LinkPager extends Widget {
    ...
    protected function renderPageButtons() {
        ...
        if ($beginPage > 0) {
            ...
            if ($beginPage > 1) {
                $buttons[] = $this->renderPageButton('...', $beginPage - 1, null, false, false);
            }
        }
        ...
        if ($endPage < $pageCount - 1) {
            if ($endPage < $pageCount - 2) {
                $buttons[] = $this->renderPageButton('...', $endPage + 1, null, false, false);
            }
        ...
        return Html::tag("div", "<div style='float: right;margin-left:10px;'> 共" . $pageCount . "页，到第" . Html::input("text", "page", (($currentPage + 2>$pageCount)?$pageCount:$currentPage + 2), ["style" => "width:50px;display:inline;margin:0 5px 0 5px;", "class" => "form-control", "id" => "jumpPage"]) . "页" . Html::button("确定", ["class" => "am-btn am-btn-primary jumpPageBtn", "style" => "margin-left:5px;", "onclick" => "location.href='" . $url . "'+$('#jumpPage').val();"]) . "</div>" . Html::tag('ul', implode("\n", $buttons), $this->options), ["class" => "paginationDiv"]);
//        return Html::tag('ul', implode("\n", $buttons), $this->options) . " 共" . $pageCount . "页，到第" . Html::input("text", "page", $currentPage + 2, ["style" => "width:50px;display:inline;margin:0 5px 0 5px;", "class" => "form-control"]) . "页".Html::button("确定",["class"=>"am-btn am-btn-primary","style"=>"margin-left:5px;"]);
    }
