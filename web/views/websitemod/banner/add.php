...
<div class="super-theme-example">
    <form id="myform">
        ...
        <div class="form-item">
            ...
            <input name="jumpTitle" id="jumpTitle" type="text" class="easyui-validatebox easyui-textbox" placeholder="跳转标题" style="width: 230px;">
        </div>
        <div class="form-item">
            <label for="" class="label-top">跳转地址：</label>
            <input name="jumpUrl" id="jumpUrl" type="text" class="easyui-validatebox easyui-textbox" placeholder="跳转地址" style="width: 230px;">
...
//        html = editor.html();
        ...
        $.ajax({
            url: '/websitemod/banner/add-banner',
            async: false,
            type: 'POST',
            processData: false,
            contentType: false,
